...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDemangle "${_IMPORT_PREFIX}/lib/libLLVMDemangle.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDemangle.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMSupport "${_IMPORT_PREFIX}/lib/libLLVMSupport.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMSupport.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMTableGen "${_IMPORT_PREFIX}/lib/libLLVMTableGen.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMTableGen.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMTableGenGlobalISel "${_IMPORT_PREFIX}/lib/libLLVMTableGenGlobalISel.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMTableGenGlobalISel.dll" )
...
set_target_properties(LLVMCore PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMRemarks;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMCore.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCore "${_IMPORT_PREFIX}/lib/libLLVMCore.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCore.dll" )
...
set_target_properties(LLVMFuzzMutate PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCore;LLVMScalarOpts;LLVMSupport;LLVMTarget"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMFuzzMutate.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMFuzzMutate )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMFuzzMutate "${_IMPORT_PREFIX}/lib/libLLVMFuzzMutate.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMFuzzMutate.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMFileCheck "${_IMPORT_PREFIX}/lib/libLLVMFileCheck.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMFileCheck.dll" )
...
set_target_properties(LLVMInterfaceStub PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMMC;LLVMObject;LLVMSupport"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMInterfaceStub "${_IMPORT_PREFIX}/lib/libLLVMInterfaceStub.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMInterfaceStub.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMIRReader "${_IMPORT_PREFIX}/lib/libLLVMIRReader.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMIRReader.dll" )
...
set_target_properties(LLVMCodeGen PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCore;LLVMMC;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTransformUtils"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMCodeGen.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMCodeGen )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCodeGen "${_IMPORT_PREFIX}/lib/libLLVMCodeGen.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCodeGen.dll" )
...
set_target_properties(LLVMSelectionDAG PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMCodeGen;LLVMCore;LLVMMC;LLVMSupport;LLVMTarget;LLVMTransformUtils"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMSelectionDAG "${_IMPORT_PREFIX}/lib/libLLVMSelectionDAG.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMSelectionDAG.dll" )
...
set_target_properties(LLVMAsmPrinter PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMBinaryFormat;LLVMCodeGen;LLVMCore;LLVMDebugInfoCodeView;LLVMDebugInfoDWARF;LLVMDebugInfoMSF;LLVMMC;LLVMMCParser;LLVMRemarks;LLVMSupport;LLVMTarget"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMAsmPrinter.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMAsmPrinter )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMAsmPrinter "${_IMPORT_PREFIX}/lib/libLLVMAsmPrinter.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMAsmPrinter.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMIRParser "${_IMPORT_PREFIX}/lib/libLLVMMIRParser.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMIRParser.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMGlobalISel "${_IMPORT_PREFIX}/lib/libLLVMGlobalISel.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMGlobalISel.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMBinaryFormat "${_IMPORT_PREFIX}/lib/libLLVMBinaryFormat.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMBinaryFormat.dll" )
...
set_target_properties(LLVMBitReader PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBitstreamReader;LLVMCore;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMBitReader.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMBitReader )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMBitReader "${_IMPORT_PREFIX}/lib/libLLVMBitReader.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMBitReader.dll" )
...
set_target_properties(LLVMBitWriter PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMCore;LLVMMC;LLVMObject;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMBitWriter.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMBitWriter )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMBitWriter "${_IMPORT_PREFIX}/lib/libLLVMBitWriter.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMBitWriter.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMBitstreamReader "${_IMPORT_PREFIX}/lib/libLLVMBitstreamReader.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMBitstreamReader.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDWARFLinker "${_IMPORT_PREFIX}/lib/libLLVMDWARFLinker.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDWARFLinker.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMExtensions "${_IMPORT_PREFIX}/lib/libLLVMExtensions.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMExtensions.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMFrontendOpenACC "${_IMPORT_PREFIX}/lib/libLLVMFrontendOpenACC.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMFrontendOpenACC.dll" )
...
set_target_properties(LLVMFrontendOpenMP PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMSupport;LLVMTransformUtils;LLVMAnalysis;LLVMMC;LLVMScalarOpts"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMFrontendOpenMP "${_IMPORT_PREFIX}/lib/libLLVMFrontendOpenMP.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMFrontendOpenMP.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMTransformUtils "${_IMPORT_PREFIX}/lib/libLLVMTransformUtils.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMTransformUtils.dll" )
...
set_target_properties(LLVMInstrumentation PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMCore;LLVMMC;LLVMSupport;LLVMTransformUtils;LLVMProfileData"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMInstrumentation "${_IMPORT_PREFIX}/lib/libLLVMInstrumentation.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMInstrumentation.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMAggressiveInstCombine "${_IMPORT_PREFIX}/lib/libLLVMAggressiveInstCombine.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMAggressiveInstCombine.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMInstCombine "${_IMPORT_PREFIX}/lib/libLLVMInstCombine.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMInstCombine.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMScalarOpts "${_IMPORT_PREFIX}/lib/libLLVMScalarOpts.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMScalarOpts.dll" )
...
set_target_properties(LLVMipo PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAggressiveInstCombine;LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCore;LLVMFrontendOpenMP;LLVMInstCombine;LLVMIRReader;LLVMLinker;LLVMObject;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTransformUtils;LLVMVectorize;LLVMInstrumentation"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMipo.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMipo )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMipo "${_IMPORT_PREFIX}/lib/libLLVMipo.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMipo.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMVectorize "${_IMPORT_PREFIX}/lib/libLLVMVectorize.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMVectorize.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMObjCARCOpts "${_IMPORT_PREFIX}/lib/libLLVMObjCARCOpts.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMObjCARCOpts.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCoroutines "${_IMPORT_PREFIX}/lib/libLLVMCoroutines.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCoroutines.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCFGuard "${_IMPORT_PREFIX}/lib/libLLVMCFGuard.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCFGuard.dll" )
...
set_target_properties(LLVMLinker PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMObject;LLVMSupport;LLVMTransformUtils"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMLinker.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMLinker )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMLinker "${_IMPORT_PREFIX}/lib/libLLVMLinker.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMLinker.dll" )
...
set_target_properties(LLVMAnalysis PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMCore;LLVMObject;LLVMProfileData;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMAnalysis.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMAnalysis )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMAnalysis "${_IMPORT_PREFIX}/lib/libLLVMAnalysis.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMAnalysis.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMLTO "${_IMPORT_PREFIX}/lib/libLLVMLTO.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMLTO.dll" )
...
set_target_properties(LLVMMC PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMSupport;LLVMBinaryFormat;LLVMDebugInfoCodeView"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMMC.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMMC )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMC "${_IMPORT_PREFIX}/lib/libLLVMMC.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMC.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMCParser "${_IMPORT_PREFIX}/lib/libLLVMMCParser.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMCParser.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMCDisassembler "${_IMPORT_PREFIX}/lib/libLLVMMCDisassembler.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMCDisassembler.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMCA "${_IMPORT_PREFIX}/lib/libLLVMMCA.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMCA.dll" )
...
set_target_properties(LLVMObject PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBitReader;LLVMCore;LLVMMC;LLVMBinaryFormat;LLVMMCParser;LLVMSupport;LLVMTextAPI"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMObject.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMObject )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMObject "${_IMPORT_PREFIX}/lib/libLLVMObject.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMObject.dll" )
...
set_target_properties(LLVMObjectYAML PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMObject;LLVMSupport;LLVMDebugInfoCodeView;LLVMMC"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMObjectYAML.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMObjectYAML )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMObjectYAML "${_IMPORT_PREFIX}/lib/libLLVMObjectYAML.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMObjectYAML.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMOption "${_IMPORT_PREFIX}/lib/libLLVMOption.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMOption.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMRemarks "${_IMPORT_PREFIX}/lib/libLLVMRemarks.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMRemarks.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebuginfod "${_IMPORT_PREFIX}/lib/libLLVMDebuginfod.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebuginfod.dll" )
...
set_target_properties(LLVMDebugInfoDWARF PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMObject;LLVMMC;LLVMSupport"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebugInfoDWARF "${_IMPORT_PREFIX}/lib/libLLVMDebugInfoDWARF.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebugInfoDWARF.dll" )
...
set_target_properties(LLVMDebugInfoGSYM PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMMC;LLVMObject;LLVMSupport;LLVMDebugInfoDWARF"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebugInfoGSYM "${_IMPORT_PREFIX}/lib/libLLVMDebugInfoGSYM.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebugInfoGSYM.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebugInfoMSF "${_IMPORT_PREFIX}/lib/libLLVMDebugInfoMSF.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebugInfoMSF.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebugInfoCodeView "${_IMPORT_PREFIX}/lib/libLLVMDebugInfoCodeView.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebugInfoCodeView.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDebugInfoPDB "${_IMPORT_PREFIX}/lib/libLLVMDebugInfoPDB.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDebugInfoPDB.dll" )
...
set_target_properties(LLVMSymbolize PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMDebugInfoDWARF;LLVMDebugInfoPDB;LLVMObject;LLVMSupport;LLVMDemangle"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMSymbolize.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMSymbolize )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMSymbolize "${_IMPORT_PREFIX}/lib/libLLVMSymbolize.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMSymbolize.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDWP "${_IMPORT_PREFIX}/lib/libLLVMDWP.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDWP.dll" )
...
set_target_properties(LLVMExecutionEngine PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMMC;LLVMObject;LLVMOrcTargetProcess;LLVMSupport;LLVMTarget"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMExecutionEngine "${_IMPORT_PREFIX}/lib/libLLVMExecutionEngine.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMExecutionEngine.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMInterpreter "${_IMPORT_PREFIX}/lib/libLLVMInterpreter.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMInterpreter.dll" )
...
set_target_properties(LLVMJITLink PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMObject;LLVMOrcShared;LLVMOrcTargetProcess;LLVMSupport;LLVMBinaryFormat"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMJITLink.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMJITLink )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMJITLink "${_IMPORT_PREFIX}/lib/libLLVMJITLink.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMJITLink.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMMCJIT "${_IMPORT_PREFIX}/lib/libLLVMMCJIT.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMMCJIT.dll" )
...
set_target_properties(LLVMOrcJIT PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMPasses;LLVMCore;LLVMExecutionEngine;LLVMJITLink;LLVMObject;LLVMOrcShared;LLVMOrcTargetProcess;LLVMMC;LLVMMCDisassembler;LLVMRuntimeDyld;LLVMSupport;LLVMTarget;LLVMTransformUtils"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMOrcJIT.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMOrcJIT )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMOrcJIT "${_IMPORT_PREFIX}/lib/libLLVMOrcJIT.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMOrcJIT.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMOrcShared "${_IMPORT_PREFIX}/lib/libLLVMOrcShared.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMOrcShared.dll" )
...
set_target_properties(LLVMOrcTargetProcess PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMOrcShared;LLVMSupport"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMOrcTargetProcess "${_IMPORT_PREFIX}/lib/libLLVMOrcTargetProcess.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMOrcTargetProcess.dll" )
...
set_target_properties(LLVMRuntimeDyld PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMMC;LLVMObject;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMRuntimeDyld.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMRuntimeDyld )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMRuntimeDyld "${_IMPORT_PREFIX}/lib/libLLVMRuntimeDyld.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMRuntimeDyld.dll" )
...
set_target_properties(LLVMTarget PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMCore;LLVMMC;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMTarget.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMTarget )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMTarget "${_IMPORT_PREFIX}/lib/libLLVMTarget.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMTarget.dll" )
...
set_target_properties(LLVMX86CodeGen PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMAsmPrinter;LLVMCodeGen;LLVMCore;LLVMInstrumentation;LLVMMC;LLVMSelectionDAG;LLVMSupport;LLVMTarget;LLVMTransformUtils;LLVMX86Desc;LLVMX86Info;LLVMGlobalISel;LLVMProfileData;LLVMCFGuard"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMX86CodeGen.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMX86CodeGen )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86CodeGen "${_IMPORT_PREFIX}/lib/libLLVMX86CodeGen.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86CodeGen.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86AsmParser "${_IMPORT_PREFIX}/lib/libLLVMX86AsmParser.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86AsmParser.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86Disassembler "${_IMPORT_PREFIX}/lib/libLLVMX86Disassembler.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86Disassembler.dll" )
...
set_target_properties(LLVMX86TargetMCA PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMMC;LLVMMCParser;LLVMX86Desc;LLVMX86Info;LLVMSupport;LLVMMCA"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86TargetMCA "${_IMPORT_PREFIX}/lib/libLLVMX86TargetMCA.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86TargetMCA.dll" )
...
set_target_properties(LLVMX86Desc PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMMC;LLVMMCDisassembler;LLVMSupport;LLVMX86Info;LLVMBinaryFormat"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMX86Desc.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMX86Desc )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86Desc "${_IMPORT_PREFIX}/lib/libLLVMX86Desc.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86Desc.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMX86Info "${_IMPORT_PREFIX}/lib/libLLVMX86Info.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMX86Info.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMAsmParser "${_IMPORT_PREFIX}/lib/libLLVMAsmParser.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMAsmParser.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMLineEditor "${_IMPORT_PREFIX}/lib/libLLVMLineEditor.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMLineEditor.dll" )
...
set_target_properties(LLVMProfileData PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMSupport;LLVMDemangle;LLVMObject;LLVMDebugInfoDWARF"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMProfileData.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMProfileData )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMProfileData "${_IMPORT_PREFIX}/lib/libLLVMProfileData.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMProfileData.dll" )
...
set_target_properties(LLVMCoverage PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMCore;LLVMObject;LLVMProfileData;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMCoverage.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMCoverage )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCoverage "${_IMPORT_PREFIX}/lib/libLLVMCoverage.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCoverage.dll" )
...
set_target_properties(LLVMPasses PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAggressiveInstCombine;LLVMAnalysis;LLVMCore;LLVMCoroutines;LLVMipo;LLVMInstCombine;LLVMObjCARCOpts;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTransformUtils;LLVMVectorize;LLVMInstrumentation"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMPasses.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMPasses )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMPasses "${_IMPORT_PREFIX}/lib/libLLVMPasses.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMPasses.dll" )
...
set_target_properties(LLVMTextAPI PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMSupport;LLVMBinaryFormat"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMTextAPI.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMTextAPI )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMTextAPI "${_IMPORT_PREFIX}/lib/libLLVMTextAPI.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMTextAPI.dll" )
...
set_target_properties(LLVMDlltoolDriver PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMObject;LLVMOption;LLVMSupport"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDlltoolDriver "${_IMPORT_PREFIX}/lib/libLLVMDlltoolDriver.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDlltoolDriver.dll" )
...
set_target_properties(LLVMLibDriver PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMBinaryFormat;LLVMBitReader;LLVMObject;LLVMOption;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMLibDriver.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMLibDriver )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMLibDriver "${_IMPORT_PREFIX}/lib/libLLVMLibDriver.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMLibDriver.dll" )
...
set_target_properties(LLVMXRay PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMSupport;LLVMObject"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMXRay.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMXRay )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMXRay "${_IMPORT_PREFIX}/lib/libLLVMXRay.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMXRay.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMWindowsManifest "${_IMPORT_PREFIX}/lib/libLLVMWindowsManifest.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMWindowsManifest.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_FileCheck "${_IMPORT_PREFIX}/bin/FileCheck.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_llvm-PerfectShuffle "${_IMPORT_PREFIX}/bin/llvm-PerfectShuffle.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_count "${_IMPORT_PREFIX}/bin/count.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_not "${_IMPORT_PREFIX}/bin/not.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_yaml-bench "${_IMPORT_PREFIX}/bin/yaml-bench.exe" )
...
set_target_properties(LTO PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMX86AsmParser;LLVMX86CodeGen;LLVMX86Desc;LLVMX86Disassembler;LLVMX86Info;LLVMBitReader;LLVMCore;LLVMCodeGen;LLVMLTO;LLVMMC;LLVMMCDisassembler;LLVMSupport;LLVMTarget"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLTO.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LTO )
list(APPEND _IMPORT_CHECK_FILES_FOR_LTO "${_IMPORT_PREFIX}/lib/libLTO.dll.a" "${_IMPORT_PREFIX}/bin/libLTO.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_lli-child-target "${_IMPORT_PREFIX}/bin/lli-child-target.exe" )
...
set_target_properties(LLVMCFIVerify PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMDebugInfoDWARF;LLVMMC;LLVMMCParser;LLVMObject;LLVMSupport;LLVMSymbolize"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMCFIVerify.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMCFIVerify )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMCFIVerify "${_IMPORT_PREFIX}/lib/libLLVMCFIVerify.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMCFIVerify.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMDiff "${_IMPORT_PREFIX}/lib/libLLVMDiff.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMDiff.dll" )
...
set_target_properties(LLVMExegesisX86 PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Desc;LLVMX86Disassembler;LLVMX86Info;LLVMExegesis;LLVMCore;LLVMSupport;LLVMCodeGen"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMExegesisX86.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMExegesisX86 )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMExegesisX86 "${_IMPORT_PREFIX}/lib/libLLVMExegesisX86.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMExegesisX86.dll" )
...
set_target_properties(LLVMExegesis PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMAnalysis;LLVMCodeGen;LLVMCore;LLVMExecutionEngine;LLVMGlobalISel;LLVMMC;LLVMMCDisassembler;LLVMMCJIT;LLVMMCParser;LLVMObject;LLVMObjectYAML;LLVMRuntimeDyld;LLVMSupport"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libLLVMExegesis.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMExegesis )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMExegesis "${_IMPORT_PREFIX}/lib/libLLVMExegesis.dll.a" "${_IMPORT_PREFIX}/bin/libLLVMExegesis.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_llvm-jitlink-executor "${_IMPORT_PREFIX}/bin/llvm-jitlink-executor.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_llvm-tapi-diff "${_IMPORT_PREFIX}/bin/llvm-tapi-diff.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_Remarks "${_IMPORT_PREFIX}/lib/libRemarks.dll.a" "${_IMPORT_PREFIX}/bin/libRemarks.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_split-file "${_IMPORT_PREFIX}/bin/split-file.exe" )
