...
#define version_string "12.1.0"
#define pkgversion_string "(MinGW-W64 x86_64-posix-seh, built by Brecht Sanders) "
...
#define GCOV_VERSION ((gcov_unsigned_t)0x4232312a)  /* B21* */
