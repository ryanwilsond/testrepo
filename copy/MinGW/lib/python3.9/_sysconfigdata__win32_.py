...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
              '-Wl,--dynamicbase -Wl,--high-entropy-va -shared '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc.exe -Wl,--nxcompat -Wl,--disable-auto-image-base -Wl,--dynamicbase '
       '-Wl,--high-entropy-va',
 'CCSHARED': '',
 ...
 'CONFIG_ARGS': "'--prefix=' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python' "
                ...
                "'host_alias=x86_64-w64-mingw32' 'CC=gcc.exe -Wl,--nxcompat "
                '-Wl,--disable-auto-image-base -Wl,--dynamicbase '
                "-Wl,--high-entropy-va' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/R/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw/build_win/coverage.info',
 'COVERAGE_REPORT': '/R/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw/build_win/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include -I../PC  -I.',
 'CXX': 'g++.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
                '-Wl,--dynamicbase -Wl,--high-entropy-va -shared '
                '-Wl,--enable-auto-image-base',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
             '-Wl,--dynamicbase -Wl,--high-entropy-va -shared '
             '-Wl,--enable-auto-image-base',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LINKCC': 'gcc.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
           '-Wl,--dynamicbase -Wl,--high-entropy-va',
 ...
 'MAINCC': 'gcc.exe -Wl,--nxcompat -Wl,--disable-auto-image-base '
           '-Wl,--dynamicbase -Wl,--high-entropy-va',
 'MAJOR_IN_MKDEV': 0,
 ...
 'VERSION': '3.9',
 'VPATH': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw',
 'VPATH_b2h': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw',
 'WINDOW_HAS_FLAGS': 0,
 'WINDRES': 'windres',
 ...
 'abs_builddir': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw/build_win',
 'abs_builddir_b2h': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw/build_win',
 'abs_srcdir': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw',
 'abs_srcdir_b2h': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw',
 ...
 'prefix': '',
 'prefix_b2h': '',
 'srcdir': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw',
 'srcdir_b2h': 'R:/winlibs64_stage/cpython-mingw-3.9.7/cpython-mingw'}
